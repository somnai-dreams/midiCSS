...
const pump: Song = {
  ...
  tracks: [
    ...
    { name: "Kick", wave: `url('${KIT.kick}')`, vol: 0.3, hue: 10, synth: "--verb:0.03;--width:0;--root:40;--sidechain:1", notes: pumpKick },
    { name: "Hats", wave: `url('${KIT.hatC}')`, vol: 0.16, hue: 60, synth: "--verb:0.12;--pan:0.15;--root:81", notes: pumpHatsC },
    { name: "Open", wave: `url('${KIT.hatO}')`, vol: 0.15, hue: 65, synth: "--verb:0.18;--pan:0.2;--root:77", notes: pumpHatsO },
    { name: "Clap", wave: `url('${KIT.clap}')`, vol: 0.26, hue: 40, synth: "--verb:0.35;--root:64", notes: pumpClap },
